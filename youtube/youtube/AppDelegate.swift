...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //create window is UIView
        window = UIWindow(frame: UIScreen.main.bounds)
        window?.makeKeyAndVisible()
        
        let layout = UICollectionViewFlowLayout()
        //scroll direction from collectionview
//        layout.scrollDirection = .horizontal
        ...
        //change color
        //plus info.plist - add 'view controller based status bar...' set 'no'
        ...
        window?.addConstaintsWithFormat(format: "H:|[v0]|", views: statusBarBackgroundView)
        window?.addConstaintsWithFormat(format: "V:|[v0(20)]", views: statusBarBackgroundView)
        return true
    }
